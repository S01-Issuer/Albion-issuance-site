				...
				<div class="grid grid-cols-1 gap-4 lg:gap-6">
						{#each holdings as group (group.tokenAddress)}
							...
							{#if group.fieldName.toLowerCase().includes('wressle')}
								<div class="border-t border-yellow-400 bg-yellow-50 px-4 py-2.5">
									<details>
										<summary class="flex items-center gap-2 cursor-pointer text-sm font-medium text-yellow-900 select-none">
